...
//     link.classList.add('active');// // Get all nav links
// const navLinks = document.querySelectorAll('.nav-link');
...
function compareCode() {
  ...
  var apiUrl = `https://codelens.onrender.com/compare?code1=${encodeURIComponent(userOriginalCode)}&code2=${encodeURIComponent(userModifiedCode)}`;
